...
headerBackColor    		: "#666", //表头背景颜色
headerFontColor    		: "#fff", //表头字体颜色
bodyBarBackColor  		: "#f4f4f4", //日历标题背景色
bodyBarFontColor  		: "#000", //日历标题字体色
bodyBackColor     		: "#fff", //日历背景色
bodyFontColor            : "#000", //日历字体色 
bodyHolidayFontColor     : "#f00", //假日字体色
watermarkColor 		    : "#fff",  //背景水印色
moreDayColor             : "#ccc" 
};
...
str += '.calendar{position:absolute;width:220px!important;width /**/:222px;height:184px!important;height /**/:174px;background-color:'+this.style.bodyBackColor+';border:1px solid ' + this.style.borderColor + ';left:0px;top:0px;z-index:9999;}\n';
str += '.cdrHeader{background-color:'+ this.style.headerBackColor +';width:220px;height:22px;font-size:12px;color:'+this.style.headerFontColor+';}\n';
str += '.cdrWatermark{position:absolute;left:0px;top:55px;width:220px;font-family: Arial Black;font-size:50px;color:'+this.style.watermarkColor+';z-index:1;text-align:center;}\n';
str += '.cdrBodyBar{background-color:' + this.style.bodyBarBackColor + ';font-size:12px;color:' + this.style.bodyBarFontColor + ';width:218px;height:20px;}\n';
str += '.cdrBody{width:220px;height:122px!important; height /**/:110px;font-size:12px;cursor:pointer;color:' + this.style.bodyFontColor + ';}\n';
...
str += '.cdrMenu{font-size:12px;border:1px solid #000;background-color:#fff;cursor:default;width:100%}\n';
str += 'html>body #Calendar{width:222px;174px;}';
str += '</style>\n';	
return str;
};
...
str += '<td Author="alin" onmouseover="this.className=\'headerOver\'" id="currentYear" style="width:80px;" onclick="' + this.Obj + '.showMenu(true);" onmouseout="' + this.Obj + '.hideMenu();this.className=\'\';">0</td>\n';
...
//增加处理
 			  ...
 			  if(searchCondition.time!=obj.value)
 			  	SetCondition(6,obj.value);
 		//设置日期搜索
this.hide();
};
